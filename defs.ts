...
export function createBaseDispatch(): Dispatch {
    return {
        retcode: 0,
        msg: "",
        topSeverRegionName: "",
...
export const Dispatch = {
    ...
    create < I extends Exact < DeepPartial < Dispatch > ,
    I >> (base?: I): Dispatch {
        return Dispatch.fromPartial(base ?? ({}as any));
    },
    fromPartial < I extends Exact < DeepPartial < Dispatch > ,
    I >> (object: I): Dispatch {
        const message = createBaseDispatch();
...
export function createBaseDispatch_Region(): Dispatch_Region {
    return {
        name: "",
        title: "",
        dispatchUrl: "",
